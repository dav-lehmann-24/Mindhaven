...
![picture](Pictures/CreateAcc.png)<br>
...
- **Form Availability:** All required fields (e.g., username, email, password) are visible and accessible on the form, with proper client-side validation scripts in place (e.g., for email format, password match).
...
- **Account Creation:** A new user account is successfully created in the database. This includes:
   ...
   - Ensuring the account details adhere to the system’s validation rules (e.g., unique email and username).
- **User Authentication:** 
The user is shown a login prompt, requiring them to manually log in using the newly created credentials.
