...
router.get('/:id/tasks', verifyToken, buddyController.getBuddyTasks);
router.post('/:id/tasks', verifyToken, buddyController.addBuddyTask);
router.patch('/:id/tasks/:taskId', verifyToken, buddyController.toggleBuddyTask);
